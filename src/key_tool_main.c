...
static bool parse_args(int argc, char** argv, struct args* args)
{
    ...
    if (!gopt_arg(options, OPTION_INPUT_FORMAT, &args->inputFormat)) {
        if(args->input == NULL && args->stringInput == NULL) {
...
static void print_help()
{
    ...
    printf("The Private key can be generated by the tool, provided from file, or provided directly from commandline." NEWLINE);
    printf("If a Private key is generated, it will be written to stdout in PEM, raw, and fingerprint formats." NEWLINE);
    ...
    printf(
        "     --input-format   Format of the input file (default: if --input or --string-input "
